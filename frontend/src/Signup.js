  ...
  return (
	...
	<div className="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
		...
		<div className="space-y-4">
			<input type="text" placeholder="Full Name" className="block text-sm font-bold py-3 px-4 rounded-lg w-full border outline-none" />
      <input type="number" placeholder="Age" className="block text-sm font-bold py-3 px-4 rounded-lg w-full border outline-none" />
      <input type="text" placeholder="Address" className="block text-sm font-bold py-3 px-4 rounded-lg w-full border outline-none" />
      <input type="text" placeholder="Username" className="block text-sm font-bold py-3 px-4 rounded-lg w-full border outline-none" />
			...
			<div className="text-center mt-6">
				<button className="py-1 w-64 text-xl text-white font-bold bg-blue-400 rounded-2xl">Sign Up</button>
				<p className="mt-4 text-sm font-bold">Already Sign Up? <span className="underline cursor-pointer font-bold text-blue-400"> Click here</span>
				</p>
			</div>
		</div>

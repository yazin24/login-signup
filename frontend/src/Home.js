...
<div className="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
  <div>
    <h1 className="text-2xl font-bold text-center mb-4 cursor-pointer">Sign Successfull!</h1>
  ...
  <div className="space-y-4">
    ...
    <div className="text-center mt-6">
      <button className="py-1 w-64 text-xl text-white font-bold bg-blue-400 rounded-2xl">Sign Out</button>
